...
# 当たり判定
  execute as @e[type=#mob:mobs,tag=Enemy,tag=!HurtTime,distance=..4] positioned ^3 ^ ^2.5 if entity @s[distance=..5] positioned ^-6 ^ ^ if entity @s[distance=..5] run function attack:left_click/hit
# 演出(刀剣溜め)
  function attack:left_click/sword/skill/effect/_
# リセット
