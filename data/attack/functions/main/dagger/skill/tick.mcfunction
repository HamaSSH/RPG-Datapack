# 神速切り (攻撃速度上昇、短剣装備時のみ)
  ...
  execute if score @s skill_cd matches 250 run attribute @s minecraft:generic.attack_speed modifier remove 1-0-0-1-0
  execute if score @s skill_cd matches 250 run tag @s remove DaggerTick