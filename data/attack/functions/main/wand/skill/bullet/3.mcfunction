...
# 属性ごとの弾
    ...
    execute if entity @s[tag=NeutralWandSkill] run function magic:asset/4302.homing_thunder/_
...
# 向き調整
    execute positioned ~ ~1.5 ~ as @e[type=area_effect_cloud,tag=WandSkill,distance=..0.01] run tp @s ~ ~ ~ ~ ~2
# リセット
    tag @s remove this