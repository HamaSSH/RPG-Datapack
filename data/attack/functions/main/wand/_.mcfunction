# 当たり判定
    ...
    execute as @e[type=area_effect_cloud,tag=WandInit,distance=..0.01] run function attack:main/wand/init
# 演出(杖通常初期)
    ...
    execute if score @s FireAttack matches 1.. run function attack:main/wand/effect/fire
    execute if score @s WaterAttack matches 1.. run function attack:main/wand/effect/water
