...
# 弓矢の召喚
  ...
  execute positioned ~ ~100 ~ positioned ^-1.3 ^ ^ run summon arrow ~ ~ ~ {Tags:["ArrowInit","LCArrow"]}
  execute positioned 0.0 0.0 0.0 run summon area_effect_cloud ^ ^ ^3 {Tags:["Knockback"]}
  execute positioned ~ ~100 ~ positioned ^-1.3 ^ ^ as @e[type=arrow,tag=ArrowInit,distance=..0] run function attack:main/bow/arrow/init
  execute positioned ~ ~100 ~ positioned ^1.3 ^ ^ run summon arrow ~ ~ ~ {Tags:["ArrowInit","LCArrow"]}
  execute positioned 0.0 0.0 0.0 run summon area_effect_cloud ^ ^ ^3 {Tags:["Knockback"]}
  execute positioned ~ ~100 ~ positioned ^1.3 ^ ^ as @e[type=arrow,tag=ArrowInit,distance=..0] run function attack:main/bow/arrow/init
# 演出(弓通常)
