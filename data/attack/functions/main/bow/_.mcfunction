...
# 弓矢の減算
  ...
  execute unless score @s Arrow matches 1.. if score @s LCArrow matches 1.. run function attack:main/bow/inventory_arrow
  ...
  execute if entity @s[tag=Quiver] if score @s Arrow matches 1.. if score @s LCArrow matches 1.. run function attack:main/bow/score_arrow
# リセット
  tag @s remove Quiver
  tag @s remove this