# 回転切り
  execute if score @s skill_cd matches 293..300 run function attack:main/sword/skill/_
  ...
  execute if score @s skill_cd matches 292 run function attack:main/sword/skill/reset