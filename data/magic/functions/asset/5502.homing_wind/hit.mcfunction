# Hit処理
    ...
    execute at @s positioned ~-0.8 ~-0.8 ~-0.8 as @e[type=#mob:mobs,tag=Enemy,tag=!HurtTime,dx=0.6,dy=0.6,dz=0.6,sort=nearest,limit=5] run function magic:asset/5502.homing_wind/aoe
# 当たり判定可視化
...
# 演出
    particle minecraft:sweep_attack ~ ~ ~ 0.1 0.6 0.1 0.05 8 force
