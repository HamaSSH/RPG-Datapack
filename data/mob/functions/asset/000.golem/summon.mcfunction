summon iron_golem ~ ~ ~ {CustomNameVisible:1b,DeathLootTable:"none",Health:1000f,Team:Enemy,Tags:["MobInit","Enemy"],Attributes:[{Name:"generic.max_health",Base:1000},{Name:"generic.movement_speed",Base:0.23}]}
# 見た目
