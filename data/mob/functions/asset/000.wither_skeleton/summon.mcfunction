summon wither_skeleton ~ ~ ~ {CustomNameVisible:1b,DeathLootTable:"mob:asset/000.zombie",Health:1000f,Team:Enemy,Tags:["Init","Enemy"],Attributes:[{Name:"generic.max_health",Base:1000},{Name:"generic.movement_speed",Base:0.23}]}
# 見た目
