summon zombie ~ ~ ~ {CustomNameVisible:1b,Health:1000f,Team:Enemy,Tags:["Init","Enemy"],Attributes:[{Name:"generic.max_health",Base:1000}],DeathLootTable:"mob:asset/000.zombie"}
# 見た目
