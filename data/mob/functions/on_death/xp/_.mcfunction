...
# XP表示
  ...
  execute if entity @s[type=#mob:size/short] positioned ~ ~0.4 ~ run function mob:on_death/xp/display/_
  execute if entity @s[type=#mob:size/medium] positioned ~ ~0.9 ~ run function mob:on_death/xp/display/_
  execute if entity @s[type=#mob:size/human] positioned ~ ~1.4 ~ run function mob:on_death/xp/display/_
  execute if entity @s[type=#mob:size/tall] positioned ~ ~2.0 ~ run function mob:on_death/xp/display/_
