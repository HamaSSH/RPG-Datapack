# バフスコアの減算
    ...
    execute if data storage core:temp Data.buff{bonus:"hp"} run say remove hp_buff
    execute if data storage core:temp Data.buff{bonus:"mp"} run say remove mp_buff
    execute if data storage core:temp Data.buff{bonus:"hp_regen"} run say remove hp_regen_buff
    execute if data storage core:temp Data.buff{bonus:"mp_regen"} run say remove mp_regen_buff
    execute if data storage core:temp Data.buff{bonus:"ad"} run say remove ad_buff
    execute if data storage core:temp Data.buff{bonus:"ap"} run say remove ap_buff
    execute if data storage core:temp Data.buff{bonus:"dex"} run say remove dex_buff
    execute if data storage core:temp Data.buff{bonus:"def"} run say remove def_buff
