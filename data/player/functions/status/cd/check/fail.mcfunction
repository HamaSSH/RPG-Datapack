...
# 失敗処理
  tellraw @s ["",{"text":"クールダウン中！","bold":true,"color":"red"},{"text":"   ( 残り: ","color":"gray"},{"score":{"name":"$CDSec","objective":"Temporary"},"color":"yellow"},{"text":".","color":"yellow"},{"score":{"name":"$CDDec","objective":"Temporary"},"color":"yellow"},{"text":"s","color":"yellow"},{"text":" )","color":"gray"}]
