...
# メニューを閉じたことの検知
    # 開けてから20tick以降から閉じた判定
        execute if score @s menu_timer matches 20 positioned ^ ^ ^10 as @e[type=marker,tag=MenuManager,distance=..5] positioned ^ ^ ^-10 if score @s PlayerID = @p PlayerID run tp @s ^ ^ ^10
