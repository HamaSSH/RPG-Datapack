...
# 無敵時間・戦闘タイマー
    execute unless data storage lib: Damage.Type.Natural run tag @s[type=!player] add HurtTime
    execute unless data storage lib: Damage.Type.Natural run scoreboard players set @s HurtTime 10
