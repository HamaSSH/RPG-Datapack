...
# ダメージの色
    ...
    execute if data storage lib: Damage{Type:{Natural:"Fire"}} run data modify storage lib: Damage.color set value '{"text":"","color":"#F4B566"}'
    execute if data storage lib: Damage{Type:{Natural:"Poison"}} run data modify storage lib: Damage.color set value '{"text":"","color":"#AAE675"}'
    execute if data storage lib: Damage{Type:{Natural:"Wither"}} run data modify storage lib: Damage.color set value '{"text":"","color":"#CAA8F6"}'
