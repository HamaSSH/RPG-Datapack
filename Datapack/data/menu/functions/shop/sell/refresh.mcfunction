...
# 売却メニューの初期化
    data modify entity @s Items set value [{Slot:8b,id:"gold_block",Count:1b,tag:{menu:{blank:1b}}},{Count:1b,Slot:17b,id:"barrier",tag:{menu:{blank:1b,button:"sell!"},CustomModelData:6017,display:{Name:'{"text":"売却する","color":"white","bold":true,"italic":false}'}}}]
