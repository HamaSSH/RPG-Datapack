...
# 醸造メニューの初期化
    data modify entity @s Items set value [{Count:1b,Slot:9b,id:"gray_stained_glass_pane",tag:{menu:{blank:1b},display:{Name:'{"text":""}'}}},{Count:1b,Slot:13b,id:"brewing_stand",tag:{menu:{blank:1b,button:"brew"},display:{Name:'{"text":"醸造する","bold":true,"italic":false}'}}},{Count:1b,Slot:17b,id:"gold_block",tag:{menu:{blank:1b}}}]
