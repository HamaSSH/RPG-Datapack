# Hit処理
    ...
    execute at @s positioned ~-0.8 ~-0.8 ~-0.8 as @e[type=#mob:mobs,tag=Enemy,tag=!HurtTime,dx=0.6,dy=0.6,dz=0.6,sort=nearest,limit=5] run function magic:asset/5201.water_ball/aoe
# 当たり判定可視化
