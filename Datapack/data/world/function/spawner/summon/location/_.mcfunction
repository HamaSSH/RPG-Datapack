...
# Posに抽選した座標を代入
    ...
    execute store result score $PosY Temporary run data get storage world: SpawnPos[1] 100
    ...
    execute store result storage world: SpawnPos[1] double 0.01 run scoreboard players get $PosY Temporary
