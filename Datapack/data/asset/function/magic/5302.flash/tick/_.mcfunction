...
# タイマー駆動
    execute if score @s 5104.Tick matches 10 run function asset:magic/5302.flash/tick/electro/explode
    execute if score @s 5104.Tick matches 11 as @e[type=#lib:every_mob,tag=Enemy,tag=5302.HurtTime,distance=..6] run tag @s remove 5302.HurtTime
    execute if score @s 5104.Tick matches 14 run function asset:magic/5302.flash/tick/electro/explode
    execute if score @s 5104.Tick matches 15 as @e[type=#lib:every_mob,tag=Enemy,tag=5302.HurtTime,distance=..6] run tag @s remove 5302.HurtTime
    execute if score @s 5104.Tick matches 18 run function asset:magic/5302.flash/tick/electro/explode
    execute if score @s 5104.Tick matches 19 as @e[type=#lib:every_mob,tag=Enemy,tag=5302.HurtTime,distance=..6] run tag @s remove 5302.HurtTime
    execute if score @s 5104.Tick matches 19 run kill @s