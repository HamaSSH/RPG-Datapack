...
# 当たり判定
    ...
    # 壁に当たった場合
        execute if entity @s[tag=!PassThrough] unless block ^ ^ ^ #lib:no_collision run function asset:magic/5401.earth_ball/tick/hit/block
        execute if entity @s[tag=!PassThrough] unless block ^ ^ ^0.5 #lib:no_collision run function asset:magic/5401.earth_ball/tick/hit/block
