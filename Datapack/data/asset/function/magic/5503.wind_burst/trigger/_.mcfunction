...
# 演出
    playsound entity.breeze.shoot master @a ~ ~ ~ 1.0 1.2
    playsound entity.wind_charge.wind_burst master @a ~ ~ ~ 0.8 1.3
    playsound entity.goat.screaming.long_jump master @a ~ ~ ~ 1.0 1.0
    playsound entity.goat.screaming.long_jump master @a ~ ~ ~ 1.0 1.0
    playsound resource:custom.weapon.sword master @a ~ ~ ~ 0.7 1.0
    playsound resource:custom.weapon.sword master @a ~ ~ ~ 0.7 1.0