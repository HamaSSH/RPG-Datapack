...
# 回転
    ...
    execute store result entity @s Rotation[0] float 1 run scoreboard players add $RotationX Temporary 2
...
# スパイクの範囲の演出
    ...
    execute positioned ^2.1 ^ ^2.1 run particle dust{color:[0.592,0.392,0.227],scale:1} ~ ~ ~ 0.1 0.3 0.1 0 10 force
    execute positioned ^-2.1 ^ ^2.1 run particle dust{color:[0.592,0.392,0.227],scale:1} ~ ~ ~ 0.1 0.3 0.1 0 10 force
    execute positioned ^2.1 ^ ^-2.1 run particle dust{color:[0.592,0.392,0.227],scale:1} ~ ~ ~ 0.1 0.3 0.1 0 10 force
    execute positioned ^-2.1 ^ ^-2.1 run particle dust{color:[0.592,0.392,0.227],scale:1} ~ ~ ~ 0.1 0.3 0.1 0 10 force
    execute positioned ^ ^ ^3 run particle dust{color:[0.592,0.392,0.227],scale:1} ~ ~ ~ 0.1 0.3 0.1 0 10 force
    execute positioned ^ ^ ^-3 run particle dust{color:[0.592,0.392,0.227],scale:1} ~ ~ ~ 0.1 0.3 0.1 0 10 force
    execute positioned ^3 ^ ^ run particle dust{color:[0.592,0.392,0.227],scale:1} ~ ~ ~ 0.1 0.3 0.1 0 10 force
    execute positioned ^-3 ^ ^ run particle dust{color:[0.592,0.392,0.227],scale:1} ~ ~ ~ 0.1 0.3 0.1 0 10 force
