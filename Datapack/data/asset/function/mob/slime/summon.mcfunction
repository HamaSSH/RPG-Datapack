...
# データの設定
    ...
    data modify storage asset:mob Data.namespace set value "slime"
    # 名前
...
# データの適用
    execute as @e[type=slime,tag=MobInit,distance=..0.01,limit=1] run function asset:mob/slime/init