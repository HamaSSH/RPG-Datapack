#> asset:mob/bogged_skull/summon
# 召喚処理

# 元のモブの召喚
    summon silverfish ~ ~ ~ {Silent:1b,Tags:["MobInit"],Passengers:[{id:"magma_cube",Tags:["Hitbox"]},{id:"armor_stand",Tags:["CustomModel"],ArmorItems:[{},{},{},{id:"nautilus_shell",components:{"item_model":"resource:custom/mob/bogged_skull"}}]}]}

# データの設定
    data modify storage asset:mob Data.MobID set value 12
    data modify storage asset:mob Data.namespace set value "bogged_skull"
    # 名前
    ...
    # ステータス
        ...
        data modify storage asset:mob Data.Status.Dmg set value 17
