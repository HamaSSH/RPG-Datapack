#> asset:mob/stray_skull/summon
# 召喚処理

# 元のモブの召喚
    summon silverfish ~ ~ ~ {Silent:1b,Tags:["MobInit"],Passengers:[{id:"magma_cube",Tags:["Hitbox"]},{id:"armor_stand",Tags:["CustomModel"],ArmorItems:[{},{},{},{id:"nautilus_shell",components:{"item_model":"resource:custom/mob/stray_skull"}}]}]}

# データの設定
    data modify storage asset:mob Data.MobID set value 8
    data modify storage asset:mob Data.namespace set value "stray_skull"
    # 名前
