...
# ヒットチェック
    ...
    execute positioned ~-0.5 ~-0.5 ~-0.5 as @e[type=#lib:every_mob,tag=Enemy,tag=Hit,dx=0,sort=nearest,limit=1] at @s run function asset:magic/5401.earth_ball/tick/hit/_
