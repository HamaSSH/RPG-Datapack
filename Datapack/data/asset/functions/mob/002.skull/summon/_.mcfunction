...
# 元のモブの召喚
    summon silverfish ~ ~ ~ {Silent:1b,Team:Enemy,Tags:["MobInit"],DeathLootTable:"asset:mob/death/002.skull",Passengers:[{id:"minecraft:slime",Silent:1b,Tags:["AssetMob","AutoKillVehicle"],Passengers:[{id:"minecraft:armor_stand",Marker:1b,Invisible:1b,Tags:["AssetMob","AutoKillVehicle"],ArmorItems:[{},{},{},{id:"minecraft:cod",Count:1b,tag:{CustomModelData:4}}]}]}]}
