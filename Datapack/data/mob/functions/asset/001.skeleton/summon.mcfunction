summon skeleton ~ ~ ~ {CustomNameVisible:1b,DeathLootTable:"mob:asset/001.skeleton",Health:1000f,Team:Enemy,Tags:["MobInit","Enemy"],Attributes:[{Name:"generic.max_health",Base:1000},{Name:"generic.movement_speed",Base:0.2}]}
# 見た目
