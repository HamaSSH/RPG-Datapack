...
# 状態異常のパーティクル
    execute if entity @s[tag=Weakness] at @e[tag=Enemy,tag=this,limit=1] run particle bubble_pop ~ ~0.5 ~ 0.2 0.3 0.2 0 10 force
    execute if entity @s[tag=Paralize] at @e[tag=Enemy,tag=this,limit=1] run particle dust 1000000000 1000000000 100 2 ~ ~0.9 ~ 0.2 0.1 0.2 0 7 force
