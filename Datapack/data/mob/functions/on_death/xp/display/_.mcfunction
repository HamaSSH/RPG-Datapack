...
# XP表示
    summon armor_stand ~ ~ ~ {PortalCooldown:60,CustomNameVisible:1b,Invisible:1b,NoGravity:1b,Small:1b,Tags:["XPDisplay"],ArmorItems:[{},{},{},{id:"minecraft:glass_bottle",Count:1b}],CustomName:'{"text":""}'}
