...
# 名前を適用
    ...
    execute on passengers if entity @s[tag=Hitbox] run data modify entity @s CustomName set from entity 83a-51-1-0-1 ArmorItems[3].components.minecraft:custom_name
