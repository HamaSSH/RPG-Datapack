...
# 数レベルごと
    # HP(+自然回復)
        execute if score %2 Temporary matches 0 run scoreboard players add @s BaseHP 2
        ...
        execute if score %10 Temporary matches 1 run scoreboard players add @s BaseHPRegen 15
        execute if score %10 Temporary matches 3 run scoreboard players add @s BaseHPRegen 20
        execute if score %10 Temporary matches 7 run scoreboard players add @s BaseHPRegen 25
        execute if score %10 Temporary matches 9 run scoreboard players add @s BaseHPRegen 20
        execute if score %10 Temporary matches 0 run scoreboard players add @s BaseHPRegen 70
    # MP(+自然回復)
        ...
        execute if score %10 Temporary matches 9 run scoreboard players add @s BaseMPRegen 10
    ...
    # 防御力
        execute if score %2 Temporary matches 0 run scoreboard players add @s BaseDEF 1
        execute if score %3 Temporary matches 0 run scoreboard players add @s BaseDEF 3
        execute if score %5 Temporary matches 0 run scoreboard players add @s BaseDEF 4
    # 素早さ
