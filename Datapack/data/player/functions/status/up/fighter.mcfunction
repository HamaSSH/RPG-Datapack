...
# 毎回
    ...
    scoreboard players add @s mp_base 4
...
# 数レベルごと
    ...
    # MP(+自然回復)
        execute if score %2 Temporary matches 0 run scoreboard players add @s mp_base 2
        ...
        execute if score %10 Temporary matches 0 run scoreboard players add @s mp_regen_base 50
    # 物理攻撃力
