...
# 毎回
    ...
    scoreboard players add @s hp_base 2
...
# 数レベルごと
    # HP(+自然回復)
        ...
        execute if score %5 Temporary matches 0 run scoreboard players add @s hp_base 3
    ...
    # 素早さ
        execute if score %2 Temporary matches 0 run scoreboard players add @s spd_base 2
        execute if score %3 Temporary matches 0 run scoreboard players add @s spd_base 4
        execute if score %5 Temporary matches 0 run scoreboard players add @s spd_base 5
    # 会心
        execute if score %2 Temporary matches 0 run scoreboard players add @s crt_base 2
        execute if score %3 Temporary matches 0 run scoreboard players add @s crt_base 3
        execute if score %5 Temporary matches 0 run scoreboard players add @s crt_base 5
    # 幸運
