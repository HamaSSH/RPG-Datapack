...
# ステータスバフの並びを固定しながら代入
    ...
    execute if data storage player:ui data.Buff{Status:"MP"} run data modify storage player:ui buff.main[11] set from storage player:ui data.Buff.Icon
    execute if data storage player:ui data.Buff{Status:"HPR"} run data modify storage player:ui buff.main[12] set from storage player:ui data.Buff.Icon
