...
# 右クリックで干渉できるエンティティがいればタグ付け
    ...
    execute positioned ~-0.2 ~-0.2 ~-0.2 as @e[type=#lib:every_mob,tag=InterruptLeftClick,dx=0] positioned ~-0.6 ~-0.6 ~-0.6 if entity @s[dx=0] run tag @p[tag=CanLeftClick] remove CanLeftClick
