...
execute positioned ~ ~1 ~ run particle dust_color_transition{from_color:[0.663,0.714,1],to_color:[0.141,0.271,1.0],scale:2} ^ ^ ^1.5 0.5 0.1 0.5 0 8 force
execute positioned ~ ~1 ~ run particle dust_color_transition{from_color:[0.62,0.816,1],to_color:[0.231,0.243,1.0],scale:2} ^ ^ ^1.5 0.5 0.1 0.5 0 8 force
