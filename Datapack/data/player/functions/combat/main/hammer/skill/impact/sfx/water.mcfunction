...
$particle dust_color_transition 0.663 0.714 1 2 0.141 0.271 1 ~ ~ ~ $(size) 0.8 $(size) 1 $(count) force
$particle dust_color_transition 0.62 0.816 1 2 0.231 0.243 1 ~ ~ ~ $(size) 0.8 $(size) 1 $(count) force
