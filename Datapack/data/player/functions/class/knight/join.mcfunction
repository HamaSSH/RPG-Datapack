# 「アサシン」に転職
    execute unless entity @s[team=Knight] run tellraw @a [{"selector":"@s"},{"text":"が"},{"text":"【ナイト】","color":"#81DDE1"},{"text":"Lv.","color":"gray"},{"score":{"name":"@s","objective":"lv_knight"},"bold":true},{"text":" に転職しました ！"}]
...
# XP加算処理
    ...
    scoreboard players operation @s xp = @s xp_knight
