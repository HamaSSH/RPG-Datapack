#> player:class/status/up/assassin
# レベルアップごとのステータスアップ処理
...
execute if score %2 Temporary matches 0 run scoreboard players add @s BaseSTR 5
execute if score %5 Temporary matches 0 run scoreboard players add @s BaseAGI 7
