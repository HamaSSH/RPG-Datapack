...
# 「アサシン」に転職
    execute unless entity @s[team=Assassin] run tellraw @a [{"selector":"@s"},{"text":"が"},{"text":"【アサシン】","color":"#E07D80"},{"text":"Lv.","color":"gray"},{"score":{"name":"@s","objective":"AssassinLVL"},"bold":true},{"text":" に転職しました ！"}]
...
# XP加算処理
    ...
    scoreboard players operation @s xp = @s AssassinXP
