#> player:class/assassin/status/init
# 初期ステータス

scoreboard players set @s BaseHP 40
scoreboard players set @s BaseMP 30
...
scoreboard players set @s BaseSTR 3
scoreboard players set @s BaseINT 0
scoreboard players set @s BaseDEX 0
scoreboard players set @s BaseDEF 0
scoreboard players set @s BaseAGI 50
scoreboard players set @s BaseCRT 20
