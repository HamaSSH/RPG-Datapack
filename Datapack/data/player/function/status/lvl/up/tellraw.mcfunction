...
# ステータス上昇分のtellraw
    ...
    tellraw @s [" ▸ステータスＵＰ！",{"nbt":"status_ui[0]","storage":"player:","interpret":true,"hover_event":{"action":"show_text","value":[{"text":"最大ＨＰ: "},[{"score":{"name":"$PreviousHP","objective":"Temporary"},"color":"#AAAAAA"},"\uF822→\uF822"],[{"score":{"name":"@s","objective":"BaseHP"},"bold":true}],[{"text":" (+","color":"green"},{"score":{"name":"$CurrentHP","objective":"Temporary"}},")"]]}},{"nbt":"status_ui[1]","storage":"player:","interpret":true,"hover_event":{"action":"show_text","value":[{"text":"自然回復: "},[{"score":{"name":"$PrevHPRInt","objective":"Temporary"},"color":"#AAAAAA"},".",{"score":{"name":"$PrevHPRDec10","objective":"Temporary"}},{"score":{"name":"$PrevHPRDec","objective":"Temporary"}},"/s → "],[{"score":{"name":"$BaseHPRInt","objective":"Temporary"},"bold":true},".",{"score":{"name":"$BaseHPRDec10","objective":"Temporary"}},{"score":{"name":"$BaseHPRDec","objective":"Temporary"}},"/s"],[{"text":" (+","color":"green"},{"score":{"name":"$CurrHPRInt","objective":"Temporary"}},".",{"score":{"name":"$CurrHPRDec10","objective":"Temporary"}},{"score":{"name":"$CurrHPRDec","objective":"Temporary"}},"/s)"]]}},{"nbt":"status_ui[2]","storage":"player:","interpret":true,"hover_event":{"action":"show_text","value":[{"text":"最大ＭＰ: "},[{"score":{"name":"$PreviousMP","objective":"Temporary"},"color":"#AAAAAA"},"\uF822→\uF822"],[{"score":{"name":"@s","objective":"BaseMP"},"bold":true}],[{"text":" (+","color":"green"},{"score":{"name":"$CurrentMP","objective":"Temporary"}},")"]]}},{"nbt":"status_ui[3]","storage":"player:","interpret":true,"hover_event":{"action":"show_text","value":[{"text":"自然回復: "},[{"score":{"name":"$PrevMPRInt","objective":"Temporary"},"color":"#AAAAAA"},".",{"score":{"name":"$PrevMPRDec10","objective":"Temporary"}},{"score":{"name":"$PrevMPRDec","objective":"Temporary"}},"/s → "],[{"score":{"name":"$BaseMPRInt","objective":"Temporary"},"bold":true},".",{"score":{"name":"$BaseMPRDec10","objective":"Temporary"}},{"score":{"name":"$BaseMPRDec","objective":"Temporary"}},"/s"],[{"text":" (+","color":"green"},{"score":{"name":"$CurrMPRInt","objective":"Temporary"}},".",{"score":{"name":"$CurrMPRDec10","objective":"Temporary"}},{"score":{"name":"$CurrMPRDec","objective":"Temporary"}},"/s)"]]}},{"nbt":"status_ui[4]","storage":"player:","interpret":true,"hover_event":{"action":"show_text","value":[{"text":"物理攻撃: "},[{"score":{"name":"$PreviousSTR","objective":"Temporary"},"color":"#AAAAAA"},"\uF822→\uF822"],[{"score":{"name":"@s","objective":"BaseSTR"},"bold":true}],[{"text":" (+","color":"green"},{"score":{"name":"$CurrentSTR","objective":"Temporary"}},")"]]}},{"nbt":"status_ui[5]","storage":"player:","interpret":true,"hover_event":{"action":"show_text","value":[{"text":"魔法攻撃: "},[{"score":{"name":"$PreviousINT","objective":"Temporary"},"color":"#AAAAAA"},"\uF822→\uF822"],[{"score":{"name":"@s","objective":"BaseINT"},"bold":true}],[{"text":" (+","color":"green"},{"score":{"name":"$CurrentINT","objective":"Temporary"}},")"]]}},{"nbt":"status_ui[6]","storage":"player:","interpret":true,"hover_event":{"action":"show_text","value":[{"text":"器用さ: "},[{"score":{"name":"$PreviousDEX","objective":"Temporary"},"color":"#AAAAAA"},"\uF822→\uF822"],[{"score":{"name":"@s","objective":"BaseDEX"},"bold":true}],[{"text":" (+","color":"green"},{"score":{"name":"$CurrentDEX","objective":"Temporary"}},")"]]}},{"nbt":"status_ui[7]","storage":"player:","interpret":true,"hover_event":{"action":"show_text","value":[{"text":"防御力: "},[{"score":{"name":"$PreviousDEF","objective":"Temporary"},"color":"#AAAAAA"},"\uF822→\uF822"],[{"score":{"name":"@s","objective":"BaseDEF"},"bold":true}],[{"text":" (+","color":"green"},{"score":{"name":"$CurrentDEF","objective":"Temporary"}},")"]]}},{"nbt":"status_ui[8]","storage":"player:","interpret":true,"hover_event":{"action":"show_text","value":[{"text":"素早さ: "},[{"score":{"name":"$PreviousAGI","objective":"Temporary"},"color":"#AAAAAA"},"\uF822→\uF822"],[{"score":{"name":"@s","objective":"BaseAGI"},"bold":true}],[{"text":" (+","color":"green"},{"score":{"name":"$CurrentAGI","objective":"Temporary"}},")"]]}},{"nbt":"status_ui[9]","storage":"player:","interpret":true,"hover_event":{"action":"show_text","value":[{"text":"会心: "},[{"score":{"name":"$PreviousCRT","objective":"Temporary"},"color":"#AAAAAA"},"\uF822→\uF822"],[{"score":{"name":"@s","objective":"BaseCRT"},"bold":true}],[{"text":" (+","color":"green"},{"score":{"name":"$CurrentCRT","objective":"Temporary"}},")"]]}},{"nbt":"status_ui[10]","storage":"player:","interpret":true,"hover_event":{"action":"show_text","value":[{"text":"幸運: "},[{"score":{"name":"$PreviousLUK","objective":"Temporary"},"color":"#AAAAAA"},"\uF822→\uF822"],[{"score":{"name":"@s","objective":"BaseLUK"},"bold":true}],[{"text":" (+","color":"green"},{"score":{"name":"$CurrentLUK","objective":"Temporary"}},")"]]}}]
