...
execute if entity @s[tag=ElementWater] run particle dust_color_transition{from_color:[0.663,0.714,1.0],to_color:[0.141,0.271,1.0],scale:1} ~ ~ ~ 0.07 0.07 0.07 0 5 force
...
execute if entity @s[tag=ElementWind] run particle dust_color_transition{from_color:[0.733,1.0,0.722],to_color:[0.184,1.0,0.141],scale:1} ~ ~ ~ 0.07 0.07 0.07 0 5 force