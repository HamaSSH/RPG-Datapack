...
# 属性纏い攻撃
    execute if entity @e[type=arrow,tag=Attacker,tag=ElementFire,distance=..6,limit=1] run function mob:on_hurt/element/fire/_
    ...
    execute if entity @e[type=arrow,tag=Attacker,tag=ElementEarth,distance=..6,limit=1] run function mob:on_hurt/element/earth
    execute if entity @e[type=arrow,tag=Attacker,tag=ElementWind,distance=..6,limit=1] at @s run function mob:on_hurt/element/wind/_
