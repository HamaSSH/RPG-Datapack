...
# それぞれのUIの設定
    ...
    execute if predicate player:class/is_hunter run function player:ui/arrow
    execute if predicate player:class/is_paladin run function player:ui/shield
    execute unless score @s Oxygen = @s MaxOxygen run function player:ui/oxygen
...
# UIの適用 HP/HPMax quiverRH MagicRH hpbar buff skillbar MagicLH quiverLH LVL(EXP/NEXTEXP) Gold
    title @s actionbar [{"nbt":"alignL","storage":"player:ui","interpret":true},"\uF80B\uF828\uF821","\uE090\uF822",[{"text":"","font":"shift_29px"},{"score":{"name":"@s","objective":"HP"}},"/",{"score":{"name":"@s","objective":"HPMax"},"color":"gray"}],"\uF809\uF803",{"nbt":"Quiver.LeftHanded","storage":"player:ui","interpret":true},"\uF809\uF806",{"nbt":"Magic.RightHanded","storage":"player:ui","interpret":true},"\uF828\uF821",{"nbt":"hp_bar","storage":"player:ui","interpret":true},{"nbt":"arrow","storage":"player:ui","interpret":true},{"nbt":"shield","storage":"player:ui","interpret":true},"\uF806",[{"nbt":"buff.extra","storage":"player:ui","interpret":true},{"nbt":"buff.effect.prefix","storage":"player:ui","interpret":true},{"nbt":"buff.status.prefix","storage":"player:ui","interpret":true},{"nbt":"buff.bracketL","storage":"player:ui","interpret":true},{"nbt":"buff.main","storage":"player:ui","interpret":true},{"nbt":"buff.bracketR","storage":"player:ui","interpret":true},{"nbt":"buff.status.suffix","storage":"player:ui","interpret":true},{"nbt":"buff.effect.suffix","storage":"player:ui","interpret":true},{"nbt":"buff.extra","storage":"player:ui","interpret":true}],"\uF82A\uF829",{"nbt":"skill_bar","storage":"player:ui","interpret":true},{"nbt":"oxygen","storage":"player:ui","interpret":true},"\uF80A\uF808\uF805","\uF828\uF822",{"nbt":"Magic.LeftHanded","storage":"player:ui","interpret":true},"\uF809\uF807",{"nbt":"Quiver.RightHanded","storage":"player:ui","interpret":true},"\uF80B\uF80A\uF809\uF822",[{"text":"","color":"#E0E0E0","font":"shift_23px"},{"text":"Lv. "},{"score":{"name":"@s","objective":"LVL"},"color":"white","bold":true},"  (",{"score":{"name":"@s","objective":"EXP"},"color":"#9EE082"},"/",{"score":{"name":"@s","objective":"NextEXP"}},")     ",{"score":{"name":"@s","objective":"Gold"},"color":"white"},{"text":"G","color":"#FFEE59"}],"\uF822","\uE091",{"nbt":"alignR","storage":"player:ui","interpret":true}]

# リセット
    data remove storage player:ui buff
    data remove storage player:ui Magic
    data remove storage player:ui arrow
    data remove storage player:ui shield
    ...
    data remove storage player:ui oxygen