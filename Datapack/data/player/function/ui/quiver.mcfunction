...
# 弓矢の数に応じたスぺース
    execute if score @s Arrow matches ..9 run data modify storage player:ui quiver.RightHanded set value [{"nbt":"ArrowLC","storage":"player:ui"},'\uF809\uF808\uF801\uE1D3','\uF807',{"score":{"name":"@s","objective":"Arrow"},"font":"shift_59px"},'\uF821']
    execute if score @s Arrow matches 10..999 run data modify storage player:ui quiver.RightHanded set value [{"nbt":"ArrowLC","storage":"player:ui"},'\uF809\uF808\uF801\uE1D3','\uF808\uF805',{"score":{"name":"@s","objective":"Arrow"},"font":"shift_59px"},'\uF821']
    execute if score @s Arrow matches 100..999 run data modify storage player:ui quiver.RightHanded set value [{"nbt":"ArrowLC","storage":"player:ui"},'\uF809\uF808\uF801\uE1D3','\uF809\uF803',{"score":{"name":"@s","objective":"Arrow"},"font":"shift_59px"},'\uF821']
    execute if score @s Arrow matches 1000.. run data modify storage player:ui quiver.RightHanded set value [{"nbt":"ArrowLC","storage":"player:ui"},'\uF809\uF808\uF801\uE1D3','\uF809\uF803',{"text":"999","font":"shift_59px"},'\uF821']
