...
# パッシブスキル
    # レベルアップ時のtellraw用
        ...
        execute if score @s LVL matches 10 run data modify storage player: passive_ui append value '["",[{"text":"","color":"#A9E07D"}," ▸新ﾊﾟｯｼﾌﾞｽｷﾙ!\\uF822《 ",{"text":"吸命の秘技","bold":true},"\\uF822I 》"],{"text":"\\n「物理 / 器用ダメージの一部をＨＰとして回復する」","color":"#E0E0E0"}]'
        ...
        execute if score @s LVL matches 25 run data modify storage player: passive_ui append value '["",[{"text":"","color":"#A9E07D"}," ▸ｽｷﾙﾚﾍﾞﾙｱｯﾌﾟ!\\uF822《 ",{"text":"吸命の秘技","bold":true},"\\uF822II 》"],{"text":"\\n「物理 / 器用ダメージの一部をＨＰとして更に回復する」","color":"#E0E0E0"}]'
        ...
        execute if score @s LVL matches 35 run data modify storage player: passive_ui append value '["",[{"text":"","color":"#A9E07D"}," ▸ｽｷﾙﾚﾍﾞﾙｱｯﾌﾟ!\\uF822《 ",{"text":"熟練の弓使い","bold":true},"\\uF822III 》"],{"text":"\\n「放たれる矢の本数が1→3本に増える」","color":"#E0E0E0"}]'
        execute if score @s LVL matches 40 run data modify storage player: passive_ui append value '["",[{"text":"","color":"#A9E07D"}," ▸ｽｷﾙﾚﾍﾞﾙｱｯﾌﾟ!\\uF822《 ",{"text":"吸命の秘技","bold":true},"\\uF822III 》"],{"text":"\\n「物理 / 器用ダメージの一部をＨＰとして更に回復する」","color":"#E0E0E0"}]'
