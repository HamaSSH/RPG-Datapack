...
# データ生成用のデータ取得
    execute in overworld run data modify storage item: zukanData set from block 276 -32 -414 Items[{tag:{CustomModelData:1018}}].tag
...
# 図鑑用アイテムの更新
    ...
    execute in overworld run data modify block 276 -32 -414 Items[{tag:{CustomModelData:1018}}].tag set from storage item: zukanData
