...
# チェストを開ける
    execute if score @s Timer matches 15 run playsound resource:custom.levelup master @a ~ ~ ~ 0.3 0.8
    ...
    execute if score @s Timer matches 45..90 run playsound entity.item.pickup master @a ~ ~ ~ 0.2 1.2
