...
# チェストの召喚
    summon armor_stand ~ ~ ~ {DisabledSlots:4144959,Marker:1b,Invisible:1b,Tags:["Chest","Top"],ArmorItems:[{},{},{},{id:"cod",Count:1b,tag:{CustomModelData:2}}],Pose:{Head:[0.0001f,0.0f,0.0f]}}
    summon armor_stand ~ ~ ~ {DisabledSlots:4144959,Marker:1b,Invisible:1b,Tags:["Chest","Bot"],ArmorItems:[{},{},{},{id:"cod",Count:1b,tag:{CustomModelData:3}}],Pose:{Head:[0.0001f,0.0f,0.0f]}}
# 釣りアイテムに乗せる
