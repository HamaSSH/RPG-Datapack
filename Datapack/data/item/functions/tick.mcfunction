...
# 釣り
    execute as @e[type=item] if data entity @s Item.tag.Chest if data entity @s {OnGround:1b} run function item:fishing/chest/on_ground
    execute as @e[tag=Chest,tag=Gold] at @s if data entity @s {OnGround:1b} run function item:fishing/chest/animation
    execute as @e[tag=Chest,tag=Weapon] at @s if data entity @s {OnGround:1b} run function item:fishing/chest/animation_sword
    ...
    execute as @e[type=item] if data entity @s Item.tag{MagmaBobber:1b} at @s unless entity @e[type=fishing_bobber,distance=..2,limit=1] run kill @s
