...
$execute if items entity @s weapon.mainhand written_book[custom_data~{zukan:"fish"}] unless items entity @s weapon.mainhand written_book[custom_model_data=$(item_id)] run loot replace entity @s weapon.mainhand loot asset:item/$(item_id)
...
$execute if items entity @s weapon.offhand written_book[custom_data~{zukan:"fish"}] unless items entity @s weapon.offhand written_book[custom_model_data=$(item_id)] run loot replace entity @s weapon.offhand loot asset:item/$(item_id)
