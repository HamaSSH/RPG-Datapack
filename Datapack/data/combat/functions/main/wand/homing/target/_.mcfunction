...
# Rotationの誤差±5度以上の敵はタグ剥奪
    execute positioned ^ ^ ^10 as @e[type=#mob:mobs,tag=Enemy,tag=!HurtTime,distance=..10] positioned ^ ^ ^-10 rotated ~5 ~ positioned ^1000.1 ^ ^ positioned ~ ~-1.6 ~ unless entity @s[distance=..1000] run tag @s remove Target
    execute positioned ^ ^ ^10 as @e[type=#mob:mobs,tag=Enemy,tag=!HurtTime,distance=..10] positioned ^ ^ ^-10 rotated ~-5 ~ positioned ^-1000.1 ^ ^ positioned ~ ~-1.6 ~ unless entity @s[distance=..1000] run tag @s remove Target
    execute positioned ^ ^ ^10 as @e[type=#mob:mobs,tag=Enemy,tag=!HurtTime,distance=..10] positioned ^ ^ ^-10 rotated ~ ~5 positioned ^ ^1000.1 ^ positioned ~ ~-1.6 ~ unless entity @s[distance=..1000] run tag @s remove Target
    execute positioned ^ ^ ^10 as @e[type=#mob:mobs,tag=Enemy,tag=!HurtTime,distance=..10] positioned ^ ^ ^-10 rotated ~ ~-5 positioned ^ ^-1000.1 ^ positioned ~ ~-1.6 ~ unless entity @s[distance=..1000] run tag @s remove Target
# ホーミング対象を絞る
