...
# 弓矢の減算
    ...
    execute unless predicate core:is_sneaking unless score @s Arrow matches 1.. if score @s LCArrow matches 1.. run function combat:main/bow/inventory_arrow
    ...
    execute unless predicate core:is_sneaking if entity @s[tag=Quiver] if score @s Arrow matches 1.. if score @s LCArrow matches 1.. run function combat:main/bow/score_arrow
