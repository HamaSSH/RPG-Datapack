...
function ui:enderchest/put_item {id:"enchanted_book",slot:15}
function ui:enderchest/put_item {id:"enchanted_book",slot:18}
function ui:enderchest/put_item {id:"enchanted_book",slot:19}
function ui:enderchest/put_item {id:"enchanted_book",slot:20}
function ui:enderchest/put_item {id:"enchanted_book",slot:21}
function ui:enderchest/put_item {id:"enchanted_book",slot:22}
function ui:enderchest/put_item {id:"enchanted_book",slot:23}
function ui:enderchest/put_item {id:"enchanted_book",slot:24}