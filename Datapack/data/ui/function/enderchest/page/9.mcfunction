...
function ui:enderchest/put_item {id:5401,slot:0}
function ui:enderchest/put_item {id:5402,slot:1}
function ui:enderchest/put_item {id:5404,slot:2}
...
function ui:enderchest/put_item {id:6000,slot:6}
function ui:enderchest/put_item {id:6001,slot:9}
function ui:enderchest/put_item {id:6002,slot:10}
