...
function ui:enderchest/put_item {id:"wind_ball",slot:0}
function ui:enderchest/put_item {id:"swift_step",slot:1}
function ui:enderchest/put_item {id:"wind_burst",slot:2}
function ui:enderchest/no_item {slot:3}
function ui:enderchest/no_item {slot:4}
function ui:enderchest/no_item {slot:5}
