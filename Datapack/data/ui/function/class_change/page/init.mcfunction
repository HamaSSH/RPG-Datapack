...
data modify entity @s Items set value [{Slot:9b,id:"glass_bottle",components:{"minecraft:custom_model_data":3001,"minecraft:custom_data":{ui:{item_type:"blank"}},"minecraft:hide_tooltip":{}}},{Slot:10b,id:"glass_bottle",components:{"minecraft:custom_model_data":3001,"minecraft:custom_data":{ui:{item_type:"blank"}},"minecraft:hide_tooltip":{}}},{Slot:11b,id:"player_head"},{Slot:12b,id:"glass_bottle",components:{"minecraft:custom_model_data":1011,"minecraft:custom_data":{ui:{item_type:"blank",class:"hunter"}},"minecraft:item_name":"【ハンター】"}},{Slot:13b,id:"glass_bottle",components:{"minecraft:custom_model_data":1012,"minecraft:custom_data":{ui:{item_type:"blank",class:"fighter"}},"minecraft:item_name":"【ファイター】"}},{Slot:14b,id:"glass_bottle",components:{"minecraft:custom_model_data":1013,"minecraft:custom_data":{ui:{item_type:"blank",class:"paladin"}},"minecraft:item_name":"【パラディン】"}},{Slot:15b,id:"glass_bottle",components:{"minecraft:custom_model_data":1015,"minecraft:custom_data":{ui:{item_type:"blank",class:"wizard"}},"minecraft:item_name":"【ウィザード】"}},{Slot:16b,id:"glass_bottle",components:{"minecraft:custom_model_data":3001,"minecraft:custom_data":{ui:{item_type:"blank"}},"minecraft:hide_tooltip":{}}},{Slot:17b,id:"glass_bottle",components:{"minecraft:custom_model_data":3001,"minecraft:custom_data":{ui:{item_type:"blank"}},"minecraft:hide_tooltip":{}}}]

# アイコンの詳細を設定
    item modify entity @s container.11 ui:set_profile
    item modify entity @s container.12 ui:class/hunter
    item modify entity @s container.13 ui:class/fighter
