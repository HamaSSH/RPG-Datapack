#> ui:smithing/combine/item/bonus_status/lore/generate_line
# loreの構成要素を生成
...
# ステータスバフ
    # 色
        execute if score $StatusValue Temporary matches 0.. run data modify storage ui: SingleBonus.color set value "#72FF5C"
        execute if score $StatusValue Temporary matches ..-1 run data modify storage ui: SingleBonus.color set value "#FF4D4D"
    # 符号
        execute if score $StatusValue Temporary matches 0.. run data modify storage ui: SingleBonus.sign set value "+"
        execute if score $StatusValue Temporary matches ..-1 run data modify storage ui: SingleBonus.sign set value ""