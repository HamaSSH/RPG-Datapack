...
# データの適用
    ...
    execute unless data storage ui: SingleBonus{status:"HPR"} unless data storage ui: SingleBonus{status:"MPR"} unless data storage ui: SingleBonus{amplifier:0} run function ui:smithing/combine/item/bonus_status/apply with storage ui: SingleBonus
