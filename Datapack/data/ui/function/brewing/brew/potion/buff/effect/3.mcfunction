#> ui:brewing/brew/potion/buff/effect/3
...
# エフェクトがダブってたら既存エフェクトを強化
    execute if data storage ui: PotionData{Duplicate:1b} run function ui:brewing/brew/potion/buff/effect/duplicate/3 with storage ui: Ingredient.buff[0]
