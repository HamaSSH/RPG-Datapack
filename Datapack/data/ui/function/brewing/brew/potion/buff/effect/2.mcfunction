#> ui:brewing/brew/potion/buff/effect/2
...
# エフェクトがダブってたら既存エフェクトを強化
    execute if data storage ui: PotionData{Duplicate:1b} run function ui:brewing/brew/potion/buff/effect/duplicate/2 with storage ui: Ingredient.buff[0]
