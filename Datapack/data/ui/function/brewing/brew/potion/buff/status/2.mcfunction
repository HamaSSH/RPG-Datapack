#> ui:brewing/brew/potion/buff/status/2
...
# ステータスバフがダブってたら既存ステータスバフを強化
    execute if data storage ui: PotionData{Duplicate:1b} run function ui:brewing/brew/potion/buff/status/duplicate/2 with storage ui: Ingredient.buff[0]
