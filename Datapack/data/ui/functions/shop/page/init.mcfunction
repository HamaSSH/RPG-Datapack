...
team join Shop @s
data modify entity @s Items set value [{Slot:0b,id:"glass_bottle",tag:{CustomModelData:3001,UI:{ItemType:"Blank"},display:{Name:'{"text":""}'}}},{Slot:1b,id:"glass_bottle",tag:{CustomModelData:3001,UI:{ItemType:"Blank"},display:{Name:'{"text":""}'}}},{Slot:2b,id:"glass_bottle",tag:{CustomModelData:3001,UI:{ItemType:"Blank"},display:{Name:'{"text":""}'}}},{Slot:3b,id:"glass_bottle",tag:{CustomModelData:3001,UI:{ItemType:"Blank"},display:{Name:'{"text":""}'}}},{Slot:4b,id:"glass_bottle",tag:{CustomModelData:3001,UI:{ItemType:"Blank"},display:{Name:'{"text":""}'}}},{Slot:5b,id:"glass_bottle",tag:{CustomModelData:3001,UI:{ItemType:"Blank"},display:{Name:'{"text":""}'}}},{Slot:6b,id:"glass_bottle",tag:{CustomModelData:3001,UI:{ItemType:"Blank"},display:{Name:'{"text":""}'}}},{Slot:7b,id:"glass_bottle",tag:{CustomModelData:3001,UI:{ItemType:"Blank"},display:{Name:'{"text":""}'}}},{Slot:8b,id:"glass_bottle",tag:{CustomModelData:3001,UI:{ItemType:"Blank"},display:{Name:'{"text":""}'}}},{Slot:17b,id:"glass_bottle",tag:{CustomModelData:3009,UI:{ItemType:"Sell"},display:{Name:'{"text":"売却","color":"white","bold":true,"italic":false}'}}}]
...
# 商品ページを移る用アイテムを配置するか判定
    ...
    execute on passengers if score @s ShopPage matches 1.. on vehicle run data modify entity @s Items append value {Slot:9b,id:"glass_bottle",tag:{CustomModelData:3014,UI:{ItemType:"Backward"},display:{Name:'{"text":"←","color":"white","bold":true,"italic":false}'}}}
    execute on passengers if score @s ShopPage < $TotalPage Temporary on vehicle run data modify entity @s Items append value {Slot:16b,id:"glass_bottle",tag:{CustomModelData:3015,UI:{ItemType:"Forward"},display:{Name:'{"text":"→","color":"white","bold":true,"italic":false}'}}}
