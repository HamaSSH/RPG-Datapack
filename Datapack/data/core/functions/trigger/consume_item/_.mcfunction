...
# バフ呼び出し
    execute positioned 0 0 0 as @e[type=marker,tag=ConsumeTemp,distance=..0.01,limit=1] if score @s PlayerID = @a[tag=this,limit=1] PlayerID run data modify storage player:temp Data.newBuff set from entity @s data.buff
